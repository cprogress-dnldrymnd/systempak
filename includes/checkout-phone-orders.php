                    ...
                    <div class="row">
                        ...
                        <div class="col-content d-flex align-items-center justify-content-between col">
                            <div>
                                ...
                                <p class="custom-price"> <label>Quantity</label> <input type="number" name="custom_quantity" placeholder="Enter quantity" min="1" value="1"> </p>
                                <p class="custom-price"> <label>Custom Price</label> <input type="number" name="custom_price" placeholder="Enter custom price"> </p>
...
function add_custom_extra_fee($cart)
{
    ...
    if ($custom_shipping_cost && $custom_shipping_cost != '' && $custom_shipping_cost != NULL && $custom_shipping_cost != 0) {
