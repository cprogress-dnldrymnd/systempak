...
function tech_sheet_content()
{
    ...
    foreach ($tech_sheets as $tech_sheet) {
        ...
        if ($tech_sheet_file) {
            echo '<a class="download-tech-sheet" target="_blank" href="'.wp_get_attachment_url($tech_sheet_file).'">Download <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
