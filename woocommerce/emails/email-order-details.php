...
<div class="wc-email-table-holder" style="margin-bottom: 40px;">
	...
	<table class="td table-order-details" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Tahoma', 'Arial', 'Trebuchet MS', sans-serif;" border="1">
		<thead>
			<tr class="table-row-style">
				<th class="td fs-11" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Item', 'woocommerce' ); ?></th>
				<th class="td fs-11" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></th>
				<th class="td fs-11" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Price', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tbody>
			<?php
