...
{
	wp_enqueue_style('parent-style', get_template_directory_uri() . '/style.css', NULL, 1.9);
	...
	wp_enqueue_script('systempak-main', assets_dir . 'javascripts/main.js', array('jquery'), 1.9);
}
