...
{
	wp_enqueue_style('parent-style', get_template_directory_uri() . '/style.css', NULL, 4.2);
	...
	if (is_page(8978) || is_checkout()) {
		...
		wp_enqueue_style('systempak-checkout', assets_dir . 'stylesheets/checkout/checkout.css', NULL, 5.9);
	}
